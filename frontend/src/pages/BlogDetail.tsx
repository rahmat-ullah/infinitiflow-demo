          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 text-primary-600 dark:text-primary-400 hover:text-primary-800 dark:hover:text-primary-300 transition-colors"
              >
        ...
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="flex flex-wrap items-center gap-6 text-gray-500 dark:text-gray-400 mb-6">
              ...
              <button
                onClick={handleShare}
                className="flex items-center gap-2 text-primary-600 dark:text-primary-400 hover:text-primary-800 dark:hover:text-primary-300 transition-colors"
              >
            ...
            {blog.featuredImage && (
              <div className="w-full h-96 overflow-hidden">
                ...
                {blog.featuredImage.caption && (
                  <p className="text-sm text-gray-500 dark:text-gray-400 text-center py-2 px-4 bg-gray-50 dark:bg-gray-700">
                    {blog.featuredImage.caption}
                  </p>
                )}
              </div>
          ...
          {blog.author.bio && (
            <div className="mt-8 bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-medium text-gray-900 dark:text-white mb-2">{blog.author.name}</h4>
                  <p className="text-gray-600 dark:text-gray-300">{blog.author.bio}</p>
                  {blog.author.email && (
                    <a
                      href={`mailto:${blog.author.email}`}
                      className="text-primary-600 dark:text-primary-400 hover:text-primary-800 dark:hover:text-primary-300 text-sm mt-2 inline-block transition-colors"
                    >
                      Contact Author
                    </a>
                  )}
            ...
            <div className="mt-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {relatedBlogs.map((relatedBlog) => (
                  <article key={relatedBlog._id} className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">

...
const DocumentComparisonAnimation: React.FC = () => {
  ...
  return (
    <div className="relative w-full h-64 bg-gradient-to-br from-blue-50 via-cyan-50 to-indigo-50 dark:from-accent-900 dark:via-cyan-800 dark:to-indigo-800 rounded-lg overflow-hidden">
      {/* Background Pattern */}
      <div className="absolute inset-0 opacity-10 dark:opacity-5">
        <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-r from-blue-400 to-cyan-400 dark:from-accent-700 dark:to-cyan-700 transform -rotate-12 scale-150"></div>
      </div>
      ...
      >
        <div className="p-3 border-b border-gray-100 dark:border-secondary-700">
          <div className="flex items-center gap-2 mb-1">
            <GitCompare className="w-4 h-4 text-blue-600 dark:text-accent-400" />
            <span className="text-xs font-semibold text-gray-700 dark:text-gray-300">Documents</span>
          </div>
        </div>
        ...
        <div className="p-3">
              ...
              {selectedDocuments.map((docId, i) => {
                ...
                return (
                  <div key={docId} className="flex items-center gap-2">
                    <span className="text-sm">{doc?.icon}</span> {/* Emoji */}
                    <div className="flex-1">
                      <div className="text-xs font-medium text-gray-800 dark:text-gray-100">{doc?.label}</div>
                      <div className="text-xs text-gray-500 dark:text-gray-400">{doc?.date}</div>
                    </div>
                    <span className={`text-xs px-1 py-0.5 rounded ${i === 0 ? 'bg-blue-100 dark:bg-accent-700/30 text-blue-700 dark:text-accent-300' : 'bg-green-100 dark:bg-success-700/30 text-green-700 dark:text-success-300'}`}>
                      {i === 0 ? 'A' : 'B'}
                    </span>
                  </div>
                );
          ...
          {currentStep !== 'selecting' && selectedDocuments.length === 2 && (
            <motion.div
              ...
              className="mt-3 pt-2 border-t border-gray-100 dark:border-secondary-700"
            >
              <div className="flex items-center justify-between text-xs">
                <span className="text-gray-600 dark:text-gray-400">Status:</span>
                <span className="px-2 py-1 bg-blue-100 dark:bg-accent-700/30 text-blue-700 dark:text-accent-300 rounded">
        ...
        {currentStep === 'selecting' && (
          ...
          >
            <div className="flex items-center gap-2 mb-3">
              <FileText className="w-4 h-4 text-blue-500 dark:text-accent-400" />
              <span className="text-sm font-semibold text-gray-700 dark:text-gray-300">Select Documents</span>
            </div>

            <div className="space-y-1 max-h-32 overflow-y-auto">
              {documentVersions.map((doc, i) => {
                const isSelected = selectedDocuments.includes(doc.id);
                const darkColor = doc.color.replace('-500', '-600');
                ...
                return (
                  <motion.button
                    ...
                    className={`w-full p-2 rounded-lg text-left transition-all duration-200 ${
                      isSelected
                        ? `${doc.color} dark:${darkColor} text-white shadow-lg scale-105`
        ...
        {currentStep === 'analyzing' && (
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              >
                <Zap className="w-6 h-6 text-blue-500 dark:text-accent-400" />
              </motion.div>
              <div>
                <div className="text-sm font-medium text-gray-700 dark:text-gray-300">Analyzing Differences</div>
                <div className="text-xs text-gray-500 dark:text-gray-400">🔍 Comparing {selectedDocuments.length} documents...</div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                <motion.div
                  className="bg-gradient-to-r from-blue-400 to-cyan-500 dark:from-accent-600 dark:to-cyan-700 h-2 rounded-full"
                  initial={{ width: 0 }}
      ...
      <AnimatePresence>
        {currentStep === 'comparing' && (
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              <ArrowLeftRight className="w-6 h-6 text-blue-500 dark:text-accent-400" />
              <div>
                <div className="text-sm font-medium text-gray-700 dark:text-gray-300">Document Comparison</div>
                <div className="text-xs text-gray-500 dark:text-gray-400">Highlighting differences and changes</div>
              </div>
            </div>

            {/* Sample Diff */}
            <div className="bg-gray-50 dark:bg-secondary-700 rounded-lg p-3 mb-4 max-h-32 overflow-auto">
              <div className="text-xs font-medium text-gray-600 dark:text-gray-400 mb-2">Sample Changes:</div>
              <div className="space-y-1">
                <div className="flex items-start gap-2">
                  <Plus className="w-3 h-3 text-green-500 dark:text-success-400 mt-0.5 flex-shrink-0" />
                  <span className="text-xs text-gray-700 dark:text-gray-300 bg-green-100 dark:bg-success-700/20 px-1 rounded">GDPR compliance</span>
                </div>
                <div className="flex items-start gap-2">
                  <Edit className="w-3 h-3 text-blue-500 dark:text-accent-400 mt-0.5 flex-shrink-0" />
                  <span className="text-xs text-gray-700 dark:text-gray-300">NET <span className="bg-red-100 dark:bg-error-700/20 px-1 rounded">30</span> → <span className="bg-green-100 dark:bg-success-700/20 px-1 rounded">15</span> days</span>
                </div>
                <div className="flex items-start gap-2">
                  <Plus className="w-3 h-3 text-green-500 dark:text-success-400 mt-0.5 flex-shrink-0" />
                  <span className="text-xs text-gray-700 dark:text-gray-300 bg-green-100 dark:bg-success-700/20 px-1 rounded">90-day notice period</span>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-2">
              <div className="text-center p-2 bg-green-50 dark:bg-success-700/20 rounded">
                <div className="text-xs font-bold text-green-600 dark:text-success-300">+2</div>
              ...
              <div className="text-center p-2 bg-red-50 dark:bg-error-700/20 rounded">
                <div className="text-xs font-bold text-red-600 dark:text-error-300">-1</div>
          ...
          >
            ...
            <div className="p-3 border-b border-gray-100 dark:border-secondary-700">
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-2">
                  <GitCompare className="w-4 h-4 text-blue-600 dark:text-accent-400" />
                  <span className="text-sm font-semibold text-gray-700 dark:text-gray-300">Comparison Results</span>
                  <span className="text-xs px-2 py-1 rounded bg-blue-500 dark:bg-accent-600 text-white">
              ...
              <div className="grid grid-cols-5 gap-2">
                ...
                >
                  <div className="text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">Total</div>
                  <div className="text-xs font-bold text-blue-600 dark:text-accent-400">
                ...
                <motion.div
                  ...
                  className="text-center"
                >
                  <div className="text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">Added</div>
                  <div className="text-xs font-bold text-green-600 dark:text-success-400">
                ...
                <motion.div
                  ...
                  className="text-center"
                >
                  <div className="text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">Removed</div>
                  <div className="text-xs font-bold text-red-600 dark:text-error-400">
                ...
                <motion.div
                  ...
                  className="text-center"
                >
                  <div className="text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">Modified</div>
                  <div className="text-xs font-bold text-orange-600 dark:text-warning-400">
                ...
                <motion.div
                  ...
                  className="text-center"
                >
                  <div className="text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">Similar</div>
                  <div className="text-xs font-bold text-purple-600 dark:text-primary-400"> {/* Assuming purple is primary-like */}
            ...
            <div className="p-3 max-h-24 overflow-auto">
              <AnimatePresence mode="wait">
                {!showSideBySide ? (
                  ...
                  >
                    {highlightedChanges.map((change, i) => (
                      ...
                      >
                        <div className="flex items-center justify-between mb-1">
                          <div className="flex items-center gap-2">
                            {/* Dynamic color and icon from JS, leave for now */}
                            <span className={`p-1 rounded ${getChangeTypeColor(change.type)}`}>
                              {getChangeTypeIcon(change.type)}
                            </span>
                            <span className="text-xs font-medium text-gray-800 dark:text-gray-200">Line {change.line}</span>
                          </div>
                          {/* Dynamic impact color from JS, leave for now */}
                  ...
                  >
                    {/* Original */}
                    <div className="bg-red-50 dark:bg-error-700/20 rounded-lg p-2">
                      <div className="flex items-center gap-2 mb-1">
                        <span className="text-xs px-2 py-1 bg-red-100 dark:bg-error-700/30 text-red-700 dark:text-error-300 rounded">Original</span>
                        <span className="text-xs font-medium text-gray-600 dark:text-gray-300">{getDocumentById(selectedDocuments[0])?.label}</span>
                      </div>
                      <div className="text-xs text-gray-700 dark:text-gray-300 leading-relaxed">
                        This Service Agreement governs the provision of consulting services between the parties. Payment terms are <span className="bg-red-200 dark:bg-error-700/40 px-1 rounded">NET 30 days</span> from invoice date. Either party may terminate with <span className="bg-red-200 dark:bg-error-700/40 px-1 rounded">60-day</span> written notice.
                      </div>
                    </div>

                    {/* Revised */}
                    <div className="bg-green-50 dark:bg-success-700/20 rounded-lg p-2">
                      <div className="flex items-center gap-2 mb-1">
                        <span className="text-xs px-2 py-1 bg-green-100 dark:bg-success-700/30 text-green-700 dark:text-success-300 rounded">Revised</span>
                        <span className="text-xs font-medium text-gray-600 dark:text-gray-300">{getDocumentById(selectedDocuments[1])?.label}</span>
                      </div>
                      <div className="text-xs text-gray-700 dark:text-gray-300 leading-relaxed">
                        This Service Agreement governs the provision of consulting services between the parties<span className="bg-green-200 dark:bg-success-700/40 px-1 rounded">, ensuring GDPR compliance</span>. Payment terms are <span className="bg-green-200 dark:bg-success-700/40 px-1 rounded">NET 15 days</span> from invoice date. Either party may terminate with <span className="bg-green-200 dark:bg-success-700/40 px-1 rounded">90-day</span> written notice<span className="bg-green-200 dark:bg-success-700/40 px-1 rounded">, subject to data protection requirements</span>.
                      </div>
                    </div>
                  </motion.div>
                )}
      ...
      {currentStep === 'complete' && (
        <motion.div
          ...
          animate={{ opacity: 1, scale: 1 }}
          className="absolute top-4 right-4 bg-blue-500 dark:bg-accent-600 text-white p-2 rounded-full shadow-lg"
        >

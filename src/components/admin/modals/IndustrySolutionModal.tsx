...
interface IndustrySolutionModalProps {
  isOpen: boolean;
  solution: IndustrySolutionFormData;
  setSolution: React.Dispatch<React.SetStateAction<IndustrySolutionFormData>>;
  isEditing: boolean;
  onSave: () => void;
  onClose: () => void;
...
const IndustrySolutionModal: React.FC<IndustrySolutionModalProps> = ({
  isOpen,
  solution,
  setSolution,
  isEditing,
            ...
            <form onSubmit={handleSubmit} className="p-6">
              ...
              <div className="flex justify-between items-center mb-6">
                <h2 className="text-2xl font-bold text-gray-900">
                  {isEditing ? 'Edit Industry Solution' : 'Add New Industry Solution'}
                </h2>
                <button
                  type="button"
                  onClick={onClose}
                      ...
                      {solution.features.map((feature, index) => (
                        <div key={index} className="flex space-x-2">
                          <input
                            ...
                            placeholder="Enter specialized feature..."
                          />
                      ...
                      {solution.useCases.map((useCase, index) => (
                        <div key={index} className="flex space-x-2">
                          <input
                            ...
                            className="flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent text-sm"
                            placeholder="Enter common use case..."
                          />
              ...
              <div className="flex justify-end space-x-4 mt-8 pt-6 border-t border-gray-200">
                ...
                >
                  {isEditing ? 'Update Industry Solution' : 'Create Industry Solution'}
                </button>
              </div>
            </form>
          </motion.div>
...
export default IndustrySolutionModal; 